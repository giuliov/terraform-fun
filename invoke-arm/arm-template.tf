resource "azurerm_template_deployment" "arm_demo" {
  name                = "acctesttemplate-01"
  resource_group_name = azurerm_resource_group.arm_demo.name
...
DEPLOY
  ...
  parameters = {
    ...
    "jenkinsDnsPrefix"   = "tf-demo"
    "jenkinsReleaseType" = "LTS"
    "authenticationType" = "password"
    "adminPasswordOrKey" = var.adminPasswordOrKey
  }
